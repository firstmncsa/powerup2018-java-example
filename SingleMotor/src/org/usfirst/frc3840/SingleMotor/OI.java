...
public class OI {
	...
	public JoystickButton motor1Start;
	public InternalButton test1;
    ...
    public OI() {
        ...
        motor1Start = new JoystickButton(actuatorsController, 1);
        motor1Start.whenPressed(new Start());

     //   test1 = new InternalButton()
